...
let AboutComponent = class AboutComponent {
    ...
    ngOnInit() {
        this.leaderService.getLeaders()
            .subscribe((leaderList) => this.leaders = leaderList, leaderErrMsg => this.leaderErrMsg = leaderErrMsg);
    }
};
...
function visibility() {
    return Object(_angular_animations__WEBPACK_IMPORTED_MODULE_1__["trigger"])('visibility', [
        Object(_angular_animations__WEBPACK_IMPORTED_MODULE_1__["state"])('shown', Object(_angular_animations__WEBPACK_IMPORTED_MODULE_1__["style"])({ transform: 'scale(1.0)', opacity: 1 })),
        Object(_angular_animations__WEBPACK_IMPORTED_MODULE_1__["state"])('hidden', Object(_angular_animations__WEBPACK_IMPORTED_MODULE_1__["style"])({ transform: 'scale(0.5)', opacity: 0 })),
...
let ContactComponent = class ContactComponent {
    ...
    onSubmit() {
        ...
        this.feedbackService.submitFeedback(this.feedback)
            ...
            setTimeout(() => { this.feedback = null; this.showConfirm = false; }, 5 * 1000);
...
tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["ViewChild"])('fform', { static: true }),
...
let DishdetailComponent = class DishdetailComponent {
    ...
    ngOnInit() {
        ...
        this.route.params
            ...
            .subscribe(dish => { this.dish = dish; this.dishCopy = dish; this.setPrevNext(dish.id); this.visibility = 'shown'; }, errMsg => this.errMsg = errMsg);
    }
    setPrevNext(dishId) {
...
DishdetailComponent = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
    ...
    tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"]("design:paramtypes", [_services_dish_service__WEBPACK_IMPORTED_MODULE_2__["DishService"],
        ...
        _angular_forms__WEBPACK_IMPORTED_MODULE_6__["FormBuilder"], Object])
], DishdetailComponent);
...
let HomeComponent = class HomeComponent {
    ...
    ngOnInit() {
        this.dishService.getFeaturedDish()
            .subscribe((dish) => this.dish = dish, errmess => this.dishErrMsg = errmess);
        this.promotionService.getFeaturedPromotion()
            .subscribe((promotion) => this.promotion = promotion, errmess => this.promotionErrMsg = errmess);
        this.leaderService.getFeaturedLeader()
            .subscribe((leader) => this.leader = leader, errmess => this.leaderErrMsg = errmess);
    }
};
...
let MenuComponent = class MenuComponent {
    ...
    ngOnInit() {
        this.dishService.getDishes()
            ...
            .subscribe((dishes) => this.dishes = dishes, errMsg => this.errMsg = errMsg);
    }
};
...
let DishService = class DishService {
    ...
    getDishIds() {
        return this.getDishes()
            .pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_2__["map"])(dishes => dishes.map(dish => dish.id)))
...
let LeaderService = class LeaderService {
    ...
    getLeaders() {
        return this.http.get(_shared_baseurl__WEBPACK_IMPORTED_MODULE_5__["baseURL"] + 'leadership')
            .pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_2__["catchError"])(this.processHTTPMsgService.handleError));
    }
    getLeader(id) {
        return this.http.get(_shared_baseurl__WEBPACK_IMPORTED_MODULE_5__["baseURL"] + 'leadership/' + id)
            .pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_2__["catchError"])(this.processHTTPMsgService.handleError));
    }
    getFeaturedLeader() {
        return this.http.get(_shared_baseurl__WEBPACK_IMPORTED_MODULE_5__["baseURL"] + 'leadership?featured=true')
...
let ProcessHTTPMsgService = class ProcessHTTPMsgService {
    constructor() { }
    handleError(error) {
        let errMsj = error.error instanceof ErrorEvent ?
...
let PromotionService = class PromotionService {
    ...
    getPromotions() {
        return this.http.get(_shared_baseurl__WEBPACK_IMPORTED_MODULE_5__["baseURL"] + 'promotions')
            .pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_2__["catchError"])(this.processHTTPMsgService.handleError));
    }
    getPromotion(id) {
        return this.http.get(_shared_baseurl__WEBPACK_IMPORTED_MODULE_5__["baseURL"] + 'promotions' + id)
            .pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_2__["catchError"])(this.processHTTPMsgService.handleError));
    }
    getFeaturedPromotion() {
        return this.http.get(_shared_baseurl__WEBPACK_IMPORTED_MODULE_5__["baseURL"] + 'promotions?featured=true')
